...
preprocessor.preprocess_raw_data('train', source_path, sep, usecols, destination_path, group_by=True, dummy_features=False, debug=False)
...
preprocessor.preprocess_raw_data('submission', source_path, sep, usecols, destination_path, group_by=True, dummy_features=False, debug=False)
